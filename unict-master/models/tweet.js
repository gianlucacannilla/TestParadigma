...
const tweetSchema = mongoose.Schema({
    ...
    likes: {type: Number, default: 0},      //Storia 2: numero relativo ai like di un tweet
    users_likes: {type: [String]},          //Storia 2: array di utenti (stringhe) che hanno messo like al tweet
    favorites: {type: Number, default: 0},  //Storia 3: numero relativo ai favorites di un tweet
